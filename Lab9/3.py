...
def drawLineBetween(screen, index, start, end, width, color_mode,form):
    ...
    elif form == "right triangle":
        pygame.draw.polygon(screen, color_mode, ([(x, y), (x + width, y), (x, y + width)]))
    elif form == "equilateral triangle":
        #use width as the side length and also we know that height of an equilateral triangle: h = side * sqrt(3) / 2
        pygame.draw.polygon(screen, color_mode, [(x, y), (x + width, y), (x + width // 2, int(y + width * math.sqrt(3) / 2))])
    elif form == "rhombus":
        pygame.draw.polygon(screen, color_mode, [(x, y - width),(x + width, y),(x, y + width),(x - width, y)])
