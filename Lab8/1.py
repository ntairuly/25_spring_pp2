...
class Coin(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.transform.scale(pygame.image.load(r"C:\Users\User\Desktop\python_pp2\25_spring_pp2\Lab8\image\coin.png"),(50,50))
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40,SCREEN_WIDTH-40), SCREEN_HEIGHT-80)
      def move(self):
        global COIN_SCORE,P1,coins
